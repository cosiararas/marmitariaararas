...
import { MenuItem, MenuAddition, MenuGroup } from "@/data/menu";
...
export default function HomeClient({ initialMenu }: { initialMenu: MenuItem[] }) {
  const [menuData] = useState<MenuItem[]>(initialMenu);
    ...
    <div className="min-h-screen bg-[#f7f7f3]">
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-b border-amber-100">
        <div className="max-w-2xl mx-auto px-4 py-2.5 flex items-center justify-center gap-2 text-sm">
          <span className="text-amber-600 font-bold">4.9/5.0 no iFood</span>
          <span className="text-amber-300">|</span>
          <span className="text-amber-600">125+ avaliacoes</span>
          <span className="text-amber-300">|</span>
          <span className="text-amber-600 font-semibold">Selo Super</span>
        </div>
      </div>
      ...
      {!storeOpen && (
        <div className="max-w-2xl mx-auto px-4 pt-4">
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 text-center">
            ...
            <h2 className="font-bold text-amber-900 text-base">Estamos fechados agora</h2>
            <p className="text-amber-700 text-sm mt-1">Pedidos de <strong>seg-sex, 11h as 15h</strong>.<br />Veja o cardapio e faca seu pedido pelo WhatsApp!</p>
            <a
              href="https://wa.me/5519971644177?text=Oi!%20Quero%20fazer%20um%20pedido%20🍱"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-3 bg-green-500 hover:bg-green-600 text-white font-bold px-5 py-2.5 rounded-xl transition-colors text-sm"
            >
      ...
      {/* ── Footer ── */}
      <footer className="bg-stone-900 text-stone-300 mt-8">
        <div className="max-w-2xl mx-auto px-4 py-10 space-y-6">
          <div className="flex items-center gap-3">
            <img src="/logo.png" alt="Logo Marmitaria Araras" className="h-10 w-10 object-contain rounded-full" />
            <div>
              <p className="font-bold text-white text-base">Marmitaria Araras</p>
              <p className="text-xs text-stone-400 italic">Sabor de Casa, Preco Justo</p>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm">
            <div className="space-y-2">
              ...
              <p className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="shrink-0"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                <a href="https://wa.me/5519971644177" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">(19) 97164-4177</a>
              </p>
              <p className="flex items-center gap-2">
                ...
                contato@marmitariaararas.com.br
              </p>
            </div>
            <div className="space-y-2">
              <p className="flex items-center gap-2">
              ...
              <p className="flex items-center gap-2">
                ...
                <a href="https://instagram.com/marmitariaararas" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">@marmitariaararas</a>
              </p>
            </div>
          </div>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-105"
              ...
              <div className="px-4 pb-4 pt-2 border-t">
                {storeOpen ? (
                  <Button className="w-full h-12 bg-primary hover:bg-primary/90 font-bold rounded-xl text-base"
                    ...
                    {`Adicionar · R$ ${modalTotal.toFixed(2)}`}
                  </Button>
                ) : (
                  <a
                    href="https://wa.me/5519971644177?text=Oi!%20Quero%20fazer%20um%20pedido%20🍱"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 w-full h-12 bg-green-500 hover:bg-green-600 text-white font-bold rounded-xl text-base transition-colors"
                  >
          ...
          <div className="flex gap-2 mt-3 flex-wrap">
            {group.sizes.map(({ label, item }) => (
              ...
              <button
                ...
                className="flex flex-col items-center px-3 py-2 rounded-xl border-2 border-primary/40 text-primary hover:border-primary hover:bg-primary/5 active:scale-95 transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center px-3 py-2 rounded-xl border-2 border-green-300 text-green-700 hover:border-green-500 hover:bg-green-50 transition-all"
              >
                <span className="text-[10px] font-semibold uppercase tracking-wide opacity-70">{label}</span>
                <span className="text-sm font-bold">R$ {item.basePrice.toFixed(2)}</span>
              </a>
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
      <div className="flex items-center gap-3 p-3">
        ...
        {storeOpen ? (
          <button
            onClick={onAdd}
            className="w-9 h-9 rounded-full flex items-center justify-center shrink-0 transition-all bg-primary text-primary-foreground hover:bg-primary/90 active:scale-95 shadow"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 rounded-full flex items-center justify-center shrink-0 transition-all bg-green-500 text-white hover:bg-green-600 shadow"
          >
