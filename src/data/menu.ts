...
export const MENU_DATA: MenuItem[] = [
  ...
  { id: "me-carne-panela", name: "Marmitex P - Carne de Panela", description: "Especial. Acompanha arroz, feijao, batata frita e farofa.", basePrice: 27.90, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/carne-panela.png", category: "Marmitas Especiais", groups: getStandardGroups() },
  { id: "me-costelinha", name: "Marmitex P - Costelinha Suina", description: "Especial. Acompanha arroz, feijao, batata frita e farofa.", basePrice: 27.90, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/costelinha-suina.png", category: "Marmitas Especiais", groups: getStandardGroups() },
  { id: "me-macarrao", name: "Marmitex P - Especial de Macarrao", description: "Especial. Acompanha arroz, feijao e salada.", basePrice: 24.90, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/macarrao-especial.png", category: "Marmitas Especiais", groups: getStandardGroups() },
  { id: "me-frango-parm", name: "Marmitex P - Frango a Parmegiana", description: "Especial. Acompanha arroz, feijao, batata frita e farofa.", basePrice: 27.90, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/frango-parmegiana.png", category: "Marmitas Especiais", groups: getStandardGroups() },
  { id: "beb-coca-lata", name: "Coca-Cola Lata 350ml", description: "Gelada", basePrice: 7.00, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/coca-lata.png", category: "Bebidas", groups: [] },
  { id: "beb-coca-zero-lata", name: "Coca-Cola Zero Lata 350ml", description: "Gelada", basePrice: 7.00, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/coca-zero-lata.png", category: "Bebidas", groups: [] },
  { id: "beb-coca-600", name: "Coca-Cola 600ml", description: "Gelada", basePrice: 10.00, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/coca-600ml.png", category: "Bebidas", groups: [] },
  { id: "beb-coca-zero-600", name: "Coca-Cola Zero 600ml", description: "Gelada", basePrice: 10.00, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/coca-zero-600ml.png", category: "Bebidas", groups: [] },
  { id: "beb-coca-2l", name: "Coca-Cola 2 Litros", description: "Gelada", basePrice: 16.00, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/coca-2l.png", category: "Bebidas", groups: [] },
  { id: "beb-guarana-lata", name: "Guarana Antarctica Lata 350ml", description: "Gelada", basePrice: 7.00, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/guarana-lata.png", category: "Bebidas", groups: [] },
  { id: "beb-guarana-600", name: "Guarana Antarctica 600ml", description: "Gelada", basePrice: 10.00, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/guarana-600ml.png", category: "Bebidas", groups: [] },
  { id: "beb-guarana-2l", name: "Guarana Antarctica 2 Litros", description: "Gelada", basePrice: 15.00, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/guarana-2l.png", category: "Bebidas", groups: [] },
  { id: "beb-h2oh", name: "H2oh Limao 500ml", description: "Gelada", basePrice: 7.00, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/h2oh-limao.png", category: "Bebidas", groups: [] },
  { id: "beb-agua-gas", name: "Agua Mineral Lindoya c/ Gas 500ml", description: "Gelada", basePrice: 7.00, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/agua-gas.png", category: "Bebidas", groups: [] },
  { id: "beb-coca-zero-220", name: "Coca-Cola Zero 220ml", description: "Gelada", basePrice: 5.00, image: "https://energetictriggerfish-supabase.cloudfy.live/storage/v1/object/public/cardapio-fotos/coca-zero-220ml.png", category: "Bebidas", groups: [] },
];
